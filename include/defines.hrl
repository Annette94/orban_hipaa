%% AWS config
-define(ACCESS_KEY_ID, "dummytest").
-define(SECRET_ACCCESS_KEY, "dummysecret").
...
-define(MAX_LOGIN_ATTEMPTS, 3). % Maximum allowed login attempts within the rate limit window